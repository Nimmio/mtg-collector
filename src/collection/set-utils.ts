...
/** Formats a release date for display, falling back when it is unavailable. */
...
/** Converts a release date into a sortable timestamp. */
...
/** Compares two sets according to the selected collection sort order. */
